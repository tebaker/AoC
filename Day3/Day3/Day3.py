...
for i in w1RawDataArray:
    ...
    if dir == 'U':
        for j in range(0, dist):
            lastYCoord += 1
            w1CoordList.append([lastXCoord, lastYCoord])
    elif dir == 'D':
        for j in range(0, dist):
            lastYCoord -= 1
            w1CoordList.append([lastXCoord, lastYCoord])
...
for i in w2RawDataArray:
    ...
    if dir == 'U':
        for j in range(0, dist):
            ...
            if [lastXCoord, lastYCoord] in w1CoordList:

                # Writing overlap data to file
                writeStr = str(lastXCoord) + " " + str(lastYCoord)
                wf.write(writeStr)
                w2OverlapList.append([lastXCoord, lastYCoord])
    elif dir == 'D':
        for j in range(0, dist):
            lastYCoord -= 1
